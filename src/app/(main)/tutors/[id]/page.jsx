                    ...
                    <div className="card-body">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="relative w-36 h-36 rounded-full overflow-hidden border-4 border-[#EC6530]">
                                <Image src={tutor.photo}  alt={tutor.tutorName} fill
                                    className="object-cover" />
                            </div>

                            <h1 className="text-4xl font-bold mt-5 text-[#EC6530]">
                                {tutor.tutorName}
                            </h1>

                            <div className="flex gap-3 mt-3 flex-wrap justify-center">
                                <div className="badge bg-[#8FDDDF] text-black border-none">
                                    {tutor.subject}
                                </div>

                                <div className="badge bg-[#FFE3E3] text-black border-none">
                                    {tutor.teachingMode}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-8">
                            ...
                            {!noSlot && !bookingNotStarted && (
                                <div className="text-center">
                                    <Link href={`/book-session/${tutor._id}`}>
                                        <button className="btn bg-[#EC6530] hover:bg-[#d85724] border-none text-white px-10">
                                            Ready to book
                                        </button>
                                    </Link>
                                </div>
